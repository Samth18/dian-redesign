    ...
    <div className="app-wrapper">
      ...
      <div className="hero">
        <div className="hero-text">
          ...
          <div className="hero-cta">
            ...
            <button className="btn-secondary">Continuar sin cuenta</button>
          </div>
        </div>
        ...
        <div className="hero-steps">
          ...
          <div className="step" onClick={() => setShowModal(true)}>
      ...
      <main>
        ...
        <div className="actions-grid">
          <div className="action-card featured" onClick={() => setShowModal(true)}>
            <div className="action-icon"><i className="fas fa-file-invoice-dollar"></i></div>
            <div className="tooltip-badge">?</div>
          ...
          <div className="action-card">
            ...
            <div className="tooltip-badge">?</div>
            <h3>Agendar Cita</h3>
            <p>Reserve en la seccional más cercana.</p>
          </div>
          <div className="action-card">
        ...
        <div className="modal-overlay" onClick={(e) => {
          ...
          <div className="modal-content animate-fade-in">
            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '20px' }}>
              <h2 style={{ margin: 0, color: 'var(--primary-dark)' }}>Portal Transaccional</h2>
              <button 
